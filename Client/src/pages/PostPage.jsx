...
export default function PostPage() {
    ...
    return (
        <main className="p-3 flex flex-col gap-3 items-center max-w-6xl min-h-screen mx-auto">
            ...
            <div className="flex justify-between  mx-auto p-3 text-sm w-full border-b-2 border-slate-500 italic">
                <div className="flex gap-3 justify-center items-center">
                    <img className="h-10 w-10 rounded" src={author?.displayPicture} alt="Author's Picture" />
